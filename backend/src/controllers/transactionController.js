...
export const getAllCompletedTransactionsAdmin = async (_req, res) => {
  try {
    const data = await Transaction.find({ status: 'completed' })
    ...
    console.error('getAllCompletedTransactionsAdmin error', err);
